...
// Stub — the actual customer search + selection flow gets built next.
    ...
    <GarageShell title="Existing Customer" showBack backTo="/garage/work-order/new">
      <div className="flex flex-col items-center justify-center py-24 text-center">
        <div className="relative mb-5 flex items-center justify-center">
          ...
          <UserSearch size={34} strokeWidth={1.5} className="relative text-gold-400/70" />
        </div>
        <p className="text-white/40 text-sm">Customer search — coming soon</p>
      </div>
    </GarageShell>
  );
}
